...
os.chdir('/home/admin/Desktop/yolov5-fire-detection-main')    #change to directtory location
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='models/best256.tflite', help='model path or triton URL')
    ...
    parser.add_argument('--project', default='tests', help='save results to project/name')
